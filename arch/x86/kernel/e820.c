...
void __init e820__print_table(char *who)
{
	...
	for (i = 0; i < e820_table->nr_entries; i++) {
		pr_debug("%s: [mem %#018Lx-%#018Lx] ", who,
...
void __init e820__update_table_print(void)
{
	...
	pr_debug("e820: modified physical RAM map:\n");
...
__init void e820__setup_pci_gap(void)
{
	...
	pr_debug("e820: [mem %#010lx-%#010lx] available for PCI devices\n", gapstart, gapstart + gapsize - 1);
}
...
void __init e820__memory_setup_extended(u64 phys_addr, u32 data_len)
{
	...
	pr_debug("e820: extended physical RAM map:\n");
...
u64 __init e820__memblock_alloc_reserved(u64 size, u64 align)
{
	...
	if (addr) {
		...
		pr_debug("e820: update e820_table_kexec for e820__memblock_alloc_reserved()\n");
...
static unsigned long __init e820_end_pfn(unsigned long limit_pfn, enum e820_type type)
{
	...
	pr_debug("e820: last_pfn = %#lx max_arch_pfn = %#lx\n",
			 last_pfn, max_arch_pfn);
	return last_pfn;
}
...
void __init e820__finish_early_params(void)
{
	if (userdef) {
		...
		pr_debug("e820: user-defined physical RAM map:\n");
...
void __init e820__memory_setup(void)
{
	...
	pr_debug("e820: BIOS-provided physical RAM map:\n");
