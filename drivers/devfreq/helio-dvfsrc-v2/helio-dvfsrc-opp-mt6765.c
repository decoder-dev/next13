...
void dvfsrc_opp_level_mapping(void)
{
	...
	if (is_vcore_ct) {
		...
		pr_debug("%s: EFUSE vcore_opp_uv: %d, %d, %d, %d\n", __func__,
				vcore_opp_0_uv,
				vcore_opp_1_uv,
				vcore_opp_2_uv,
				vcore_opp_3_uv);
		...
		if (is_mini_sqc) {
			...
			pr_debug("%s: MINI SQC vcore_opp_uv: %d, %d, %d, %d\n",
					__func__,
					vcore_opp_0_uv,
					vcore_opp_1_uv,
					vcore_opp_2_uv,
		...
		pr_debug("%s: DRAM vcore_opp_uv: %d, %d, %d, %d\n", __func__,
				vcore_opp_0_uv,
				vcore_opp_1_uv,
				vcore_opp_2_uv,
				vcore_opp_3_uv);
		...
		vcore_opp_2_uv = 700000 - get_vb_volt(VCORE_OPP_2);
		vcore_opp_2_uv = max(vcore_opp_2_uv, vcore_opp_3_uv);
		pr_debug("%s: vcore_opp_2: %d uv (MD VB:%d)\n", __func__,
